...
import 'package:myapp658d7b3746ed317621f8/constants/appwriteconstants.dart';
...
class HomePage extends StatefulWidget {
  Client? client;
  final bool isdark;
  HomePage({super.key, required this.isdark, this.client});
...
class _HomePageState extends State<HomePage> {
  // @override
  // void initState() {
  //   final post = Databases(widget.client!).listDocuments(databaseId: AppwriteConstants.projectdatabases, collectionId: AppwriteConstants.postCollection,queries: [Queue.d('createdAt')]);
  //   super.initState();
  // }
  @override
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<HomeBloc, HomeState>(
      bloc: HomeBloc(databasesrepository: context.read<DatabasesRepository>())
        ..add(GetNewPosts()),
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              "Explore",
              style:
                  GoogleFonts.inter(fontSize: 19, fontWeight: FontWeight.bold),
            ),
